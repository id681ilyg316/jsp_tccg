...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="2" topmargin="9" background='<%=path %>/img/allbg.gif'>
			<form action="<%=path %>/yuding?type=yudingAdd" name="formAdd" method="post">
				     <table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
						...
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    ...
						    <td width="85%" bgcolor="#FFFFFF" align="left">
						        <input type="text" name="daodashi" style="width: 280px;" value="<%=new SimpleDateFormat("yyyy-MM-dd HH:mm").format(new Date(new Date().getTime()+30*60*1000)) %>"/>
						    </td>
						</tr>
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    <td width="15%" bgcolor="#FFFFFF" align="right">&nbsp;
						    ...
						    <td width="85%" bgcolor="#FFFFFF" align="left">
						       <input type="hidden" name="chewei_id" value="<%=request.getParameter("chewei_id") %>"/>
